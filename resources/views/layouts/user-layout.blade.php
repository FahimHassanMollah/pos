...
@section('main_content')
	...
	<div class="row clearfix page_header">
		...
		<div class="col-md-8 text-right">
			...
			<a class="btn btn-info"  data-toggle="modal" data-target="#newPayment" > <i class="fa fa-plus"></i> New Payment </a>
	...
	<div class="row clearfix mt-5">
		...
		<div class="col-md-2">
			<div class="nav flex-column nav-pills">
			  ...
			  <a class="nav-link  @if($tab_menu == 'purchases') active @endif" href=" {{ route('users.purchases', $user->id) }} " >Purchases</a>
			  <a class="nav-link  @if($tab_menu == 'payments') active @endif" href=" {{ route('users.payments', $user->id) }} " >Payments</a>
